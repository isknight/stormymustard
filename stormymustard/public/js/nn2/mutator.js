...
Mutator.prototype = {
     ...
     * @private
     */
    _randomlyAddNeuron: function(network) {
     ...
     * @private
     */
    _randomlyAddSynapseWithRandomWeight: function(network) {
        var neurons = [];
        var connections = [];
     ...
     * @private
     */
    _randomlyMutateSynapseWeight: function(network) {
     ...
     * @private
     */
    _randomInteger: function (max, min) {
     ...
     * @private
     */
    _randomWeight: function(max, min) {
